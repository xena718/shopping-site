...
def show_shopping_cart():
    ...
    for melon_id,count in cart_dict.items(): 
        melon = melons.get_by_id(melon_id) # we think melon here is a Melon object. correct later if we're wrong.
...
def add_to_cart(melon_id):
    ...
    flash('Your melon is successfully added to the cart! Congrats!')
